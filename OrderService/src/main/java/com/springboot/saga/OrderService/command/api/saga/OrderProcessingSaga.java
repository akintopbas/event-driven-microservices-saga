package com.springboot.saga.OrderService.command.api.saga;

import com.springboot.saga.CommonService.commands.*;
import com.springboot.saga.CommonService.events.*;
...
public class OrderProcessingSaga {
    ...
    private void handle(PaymentProcessedEvent event) {
        log.info("PaymentProcessedEvent in Saga for Order Id : {}",
                event.getOrderId());
        try {
            //TODO: HATA CASE'İNE DÜŞMESİ İÇİN HATA FIRLATTIM.
            if(true)
                throw new Exception();
